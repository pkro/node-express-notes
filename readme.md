...
- [Redis crash course](#redis-crash-course)
  ...
  - [Basic redis commands and datatypes using redis-cli](#basic-redis-commands-and-datatypes-using-redis-cli)
    - [Working with strings](#working-with-strings)
    - [Working with lists](#working-with-lists)
    - [Working with sets](#working-with-sets)
    - [Working with hashes](#working-with-hashes)
  - [Using redis to cache API calls (server side)](#using-redis-to-cache-api-calls-server-side)
- [Node JS design patterns](#node-js-design-patterns)
- [Express essential training](#express-essential-training)
  - [First steps](#first-steps)
- [Own notes](#own-notes)
  - [Setting up a typescript nodejs (+express) project](#setting-up-a-typescript-nodejs-express-project)
    - [Basic setup](#basic-setup)
    - [Adding express](#adding-express)
    - [Adding hot reloading](#adding-hot-reloading)
    - [Adding build scripts for production](#adding-build-scripts-for-production)
    - [Adding eslint + prettier](#adding-eslint--prettier)
